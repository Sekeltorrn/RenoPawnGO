...
class PawnTicketExpiredActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.pawn_ticket_expired)
        ...
        findViewById<View>(R.id.tabRedeemed)?.setOnClickListener {
            startActivity(Intent(this, PawnTicketRedeemedActivity::class.java))
            finish()
        }
    }
}
